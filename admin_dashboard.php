    ...
    <div class="container-fluid"> <!-- Changed container to container-fluid for wider navbar -->
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                <li class="nav-item">
                    <a class="nav-link" href="admin/search.php"><i class="fas fa-search"></i>Search</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="admin/delete.php"><i class="fas fa-trash"></i>Delete</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="admin/ViewSitRecords.php"><i class="fas fa-eye"></i>View Sitin Records</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="admin/generate.php"><i class="fas fa-file"></i>Generate Reports</a>
                </li>
                <li class="nav-item">
